...
<head>
  ...
  <!--[if lt IE 9]>
  <script src="${ctx}/static/img/html5shim.js"></script>
  <![endif]-->
...
<div class="navbar navbar-fixed-top bs-docs-nav" role="banner">
    ...
    <div class="conjtainer">
      ...
      <div class="navbar-header">
		  ...
		  <a href="${ctx}/login/loginCheck" class="navbar-brand hidden-lg">首页</a>
		</div>
        ...
        <ul class="nav navbar-nav pull-right">
          <li class="dropdown pull-right">            
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              <i class="icon-user"></i>${uname} <b class="caret"></b>              
            </a>
                    ...
                    <ul class="chats">
                      ...
                      <li class="by-me">
                        ...
                        <div class="avatar pull-left">
                          <img src="${ctx}/static/img/user.jpg" alt=""/>
                        </div>
              ...
              <div class="widget">
                ...
                <div class="widget-content referrer">
                  ...
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                      <td><img src="${ctx}/static/img/icons/chrome.png" alt="" />
                      <td>Google Chrome</td>
                      <td>3,005</td>
                    </tr> 
                    <tr>
                      <td><img src="${ctx}/static/img/icons/firefox.png" alt="" />
                      <td>Mozilla Firefox</td>
                      <td>2,505</td>
                    </tr> 
                    <tr>
                      <td><img src="${ctx}/static/img/icons/ie.png" alt="" />
                      <td>Internet Explorer</td>
                      <td>1,405</td>
                    </tr> 
                    <tr>
                      <td><img src="${ctx}/static/img/icons/opera.png" alt="" />
                      <td>Opera</td>
                      <td>4,005</td>
                    </tr> 
                    <tr>
                      <td><img src="${ctx}/static/img/icons/safari.png" alt="" />
                      <td>Safari</td>
                      <td>505</td>
                    </tr>                                                                    
                  </table>
